...
#     x = Conv1D(128, 3, activation='relu')(inputdata)
#     x = MaxPooling1D(2)(x)
#     x = Flatten()(x)
#     x1 = Dense(64, activation='selu')(x)
#     x1 = Dropout(0.1)(x1)
#
#
#     x = Dense(32, activation='selu')(x1)
...
def create_model_multiclass(input_dim, output_dim):
    # create model
    model = Sequential()
    model.add(layers.Conv1D(64, 50,strides=10, activation='relu', input_shape=(input_dim, 1)))#1196
    model.add(layers.Conv1D(64, 40, strides=5, activation='relu'))
